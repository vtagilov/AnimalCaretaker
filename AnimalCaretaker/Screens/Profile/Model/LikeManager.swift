...
class LikeManager {
    ...
    private func reloadModels() {
        let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "LikedPosts")
        do {
    ...
    func addLike(_ model: AnimalCellModel) {
        if let entity = NSEntityDescription.entity(forEntityName: "LikedPosts", in: context) {
